# Local copy of sxmo-nix's pkgs/superd/default.nix, patched for this
# nixpkgs revision: buildGoModule renamed vendorSha256 -> vendorHash (same
# hash value, just a field rename).
{ lib, fetchFromSourcehut, buildGoModule, scdoc }:

buildGoModule rec {
  pname = "superd";
  version = "0.3.2";
  vendorHash = "sha256-u9xEtuTqhVjKV29bfwW4tHu3HTk45UqH+yC+XQYQdQA=";
