# Local copy of sxmo-nix's pkgs/mnc/default.nix, patched for this nixpkgs
# revision: buildGoModule renamed vendorSha256 -> vendorHash (same hash
# value, just a field rename).
